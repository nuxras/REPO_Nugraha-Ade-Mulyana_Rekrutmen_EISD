...
<div class="max-w-xl mx-auto">
    ...
    <h1 class="text-2xl font-bold text-slate-800 mt-2 mb-6">Tambah Kategori Baru</h1>
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 space-y-5">
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Contoh: Jalan Rusak"
            ...
            <div>
                ...
                <input type="number" name="priority_weight" id="priority_weight" value="{{ old('priority_weight') }}" min="1" max="100" placeholder="1-100"
                ...
                <p class="text-xs text-slate-400 mt-1">Bobot ini digunakan untuk menghitung skor prioritas otomatis. Semakin tinggi bobot, laporan akan semakin prioritas.</p>
        ...
        <div class="mt-6 flex justify-end gap-3">
            ...
            <button type="submit" class="px-8 py-3 bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-400 hover:to-emerald-400 text-white font-semibold rounded-xl shadow-lg shadow-teal-500/25 transition-all duration-200 hover:-translate-y-0.5">Simpan Kategori</button>
        </div>
    </form>
</div>
@endsection