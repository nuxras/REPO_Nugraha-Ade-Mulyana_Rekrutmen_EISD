...
<div class="max-w-xl mx-auto">
    ...
    <h1 class="text-2xl font-bold text-slate-800 mt-2 mb-6">Tambah Pengguna Baru</h1>
    ...
    <form action="{{ route('admin.users.store') }}" method="POST">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 space-y-5">
            ...
            <div>
                ...
                <textarea name="address" id="address" rows="2"
                    class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-teal-400 focus:ring-2 focus:ring-teal-100 transition-all text-slate-700 @error('address') border-red-300 @enderror">{{ old('address') }}</textarea>
            ...
            <div class="border-t border-slate-100 pt-5">
                <div class="space-y-4">
                    <div>
                        <label for="password" class="block text-sm font-medium text-slate-600 mb-1.5">Password <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-sm font-medium text-slate-600 mb-1.5">Konfirmasi Password <span class="text-red-500">*</span></label>
        ...
        <div class="mt-6 flex justify-end gap-3">
            ...
            <button type="submit" class="px-8 py-3 bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-400 hover:to-emerald-400 text-white font-semibold rounded-xl shadow-lg shadow-teal-500/25 transition-all duration-200 hover:-translate-y-0.5">Simpan Pengguna</button>
        </div>
    </form>
</div>
@endsection