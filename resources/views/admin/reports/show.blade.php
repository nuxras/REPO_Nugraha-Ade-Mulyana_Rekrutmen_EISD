...
<div class="max-w-4xl mx-auto space-y-6">
    <a href="{{ route('admin.reports.index') }}" class="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-teal-600 transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <div class="p-4">
                ...
                <p class="text-xs text-slate-400 mt-1">Koordinat: {{ $report->latitude }}, {{ $report->longitude }}</p>
            </div>
        </div>
    </div>
